...
class Employee:
    ...
    # when a user create an object of class and print object directly then python return address of then object
    ...
    def ReadAllEmp(self):
        pass
        # write code here to read all the employees and return using try except
